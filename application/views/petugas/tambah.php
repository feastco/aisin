								...
								<form action="<?= base_url('petugas/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="kode" placeholder="Masukkan Kode Petugas" autocomplete="off"  class="form-control" required value="RECEIVING - <?= mt_rand(1, 99) ?>" maxlength="12" readonly>
										</div>
										<div class="form-group col-md-6">
