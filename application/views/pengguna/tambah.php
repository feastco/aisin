								...
								<form action="<?= base_url('pengguna/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="kode" placeholder="Masukkan Kode Pengguna" autocomplete="off"  class="form-control" required value="ADMIN - <?= mt_rand(1, 99) ?>" maxlength="8" readonly>
										</div>
										<div class="form-group col-md-6">
