					...
					<div class="row">
						<div class="col-md-6">
							<div class="card shadow">
								...
								<div class="card-body">
									<form action="<?= base_url('MasterPartNeed/proses_tambah') ?>" id="form-tambah" method="POST">
										<div class="form-row">
											<div class="form-group col-md-6">
												<label for="no_fg"><strong>No FG</strong></label>
												<select name="no_fg" class="form-control" required>
													<option value="">Pilih No FG</option>
										...
										<div class="form-group">
											...
											<input type="number" name="qty_need" placeholder="Masukkan Quantity Need" autocomplete="off" class="form-control" required>
										</div>
										<hr>
										<div class="form-group">
