...
class ReceivingDetail extends CI_Controller
{
    public $M_receiving;
    public function __construct()
    {
        ...
        $this->data['aktif'] = 'ReceivingDetail';
        // $this->load->model('M_master_part_need','m_master_part_need');
        $this->load->model('M_receiving_detail', 'm_receiving_detail');
        $this->M_receiving_detail = new M_receiving_detail();
    }

    public function index()
    {
        $this->data['title'] = 'Lihat Receiving Detail';
        $this->data['all_receiving_detail'] = $this->M_receiving_detail->lihat();
        if ($this->data['all_receiving_detail'] !== null) {
            $this->data['no'] = 1;
            $this->load->view('receiving_detail/lihat', $this->data);
        } else {
    ...
    public function export()
    {
        ...
        $html = $this->load->view('receiving_detail/report', $this->data, true);
